ALTER TABLE technician ADD CONSTRAINT uq_technician_id_dealership UNIQUE (id, dealership_id);
ALTER TABLE service_bay ADD CONSTRAINT uq_service_bay_id_dealership UNIQUE (id, dealership_id);
